...
@section('body')
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src={{URL::to("img/portfolio/01-thumbnail.jpg")}}  alt="First slide">
      <div class="carousel-caption  ">
     <div class="intro-text">
         
           <div class="intro-lead-in">Welcome To Kleanary!</div>
          <div class="intro-heading text-uppercase" id="countdown">It's Nice To Meet You</div>
          <a class="btn btn-rimary btn-xl text-uppercase js-scroll-trigger" href="#services">Tell Me More</a>
          
        </div>
  </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/laundry.jpg" alt="Second slide">
      <div class="carousel-caption  ">
     <div class="intro-text">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Aims</h2>
        ...
        <div class="row text-center">
          <div class="col-md-4">
            ...
            <h4 class="service-heading">E-Laundry</h4>
          ...
          <div class="col-md-4">
            ...
            <h4 class="service-heading">Digitalizing Laundry Service</h4>
          ...
          <div class="col-md-4">
            ...
            <h4 class="service-heading">Secure Laundry</h4>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Giving the best of services.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              ...
              <p class="text-muted">100% Satisfaction</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Interior & Exterior Design</h4>
              <p class="text-muted">Amiable Designs</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              ...
              <p class="text-muted">Sofisticated Designs</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              ...
              <p class="text-muted">Elegant Designs</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <ul class="timeline">
              <li>
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p class="text-muted">Cleanary begins as a vision and aim to give the best of laundry service that fit in for the modern age, given a convinient and secure laundry</p>
                  </div>
                </div>
              </li>
              <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p class="text-muted">As at January 2 2019, Cleanary stood as a laundry agent, aiming at being the number one laundry agent.</p>
                  </div>
                </div>
              </li>
              <li>
